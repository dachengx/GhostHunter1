...
fopt = "/home/xudacheng/Downloads/GHdataset/playground/first-submission-fp.h5"
'''
...
def findpeak_eff():
    ...
    with h5py.File(fipt) as probh5, h5py.File(fopt, "w") as opt:
        ent = probh5['Waveform']
